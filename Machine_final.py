...
# Function to fetch data for the specific machine ID with pagination
def fetch_machine_data(machine_id, access_token):
    single_machine_data_url = f"{base_url}/machine/single"
    all_records = []
...
# Function to convert timestamps to CEST with time in "hh:mm" format
...
def main():
    ...
    if machine_data:
        ...
        raw_output_file = "raw_machine_data.xlsx"
        ...
        structured_output_file = "structured_machine_data.xlsx"
